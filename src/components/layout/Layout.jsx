...
export default ({ children, title = 'Open Budget Client' }) => (
  <React.Fragment>
    <Head>
      ...
      <link rel='stylesheet' href='https://cdn.jsdelivr.net/npm/react-s-alert@1.4.1/dist/s-alert-default.css' crossOrigin='anonymous' />
      <link rel='stylesheet' href='https://cdn.jsdelivr.net/npm/react-s-alert@1.4.1/dist/s-alert-css-effects/stackslide.css' crossOrigin='anonymous' />
    </Head>
    <header>
